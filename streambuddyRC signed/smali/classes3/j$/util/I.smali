.class public abstract synthetic Lj$/util/I;
...
.method public static a(Lj$/util/Z;Ljava/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/Z;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/Z;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
...
.method public static c(Lj$/util/e0;Ljava/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/e0;->forEachRemaining(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/e0;->forEachRemaining(Ljava/util/function/LongConsumer;)V
...
.method public static d(Lj$/util/Z;Ljava/util/function/Consumer;)Z
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/Z;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/Z;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
...
.method public static e(Lj$/util/Spliterator$OfInt;Ljava/util/function/Consumer;)Z
    .locals 1
...
.method public static f(Lj$/util/e0;Ljava/util/function/Consumer;)Z
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/e0;->tryAdvance(Ljava/util/function/LongConsumer;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/e0;->tryAdvance(Ljava/util/function/LongConsumer;)Z
...
.method public static g(Ljava/util/Optional;)Lj$/util/D;
    .locals 1
    ...
    invoke-static {p0}, Lj$/util/D;->d(Ljava/lang/Object;)Lj$/util/D;
...
.method public static h(Ljava/util/OptionalDouble;)Lj$/util/E;
    .locals 2
...
.method public static i(Ljava/util/OptionalInt;)Lj$/util/F;
    .locals 1
    ...
    invoke-static {p0}, Lj$/util/F;->d(I)Lj$/util/F;
...
.method public static j(Ljava/util/OptionalLong;)Lj$/util/G;
    .locals 2
...
.method public static k(Lj$/util/D;)Ljava/util/Optional;
    .locals 1
    ...
    invoke-virtual {p0}, Lj$/util/D;->b()Ljava/lang/Object;
...
.method public static l(Lj$/util/E;)Ljava/util/OptionalDouble;
    .locals 2
    ...
    invoke-virtual {p0}, Lj$/util/E;->b()D
...
.method public static m(Lj$/util/F;)Ljava/util/OptionalInt;
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0}, Lj$/util/F;->c()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lj$/util/F;->b()I
...
.method public static n(Lj$/util/G;)Ljava/util/OptionalLong;
    .locals 2
    ...
    invoke-virtual {p0}, Lj$/util/G;->b()J
