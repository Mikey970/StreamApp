...
.method public final synthetic anyMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->q()Z
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->average()Lj$/util/E;

    move-result-object v0

    invoke-static {v0}, Lj$/util/I;->l(Lj$/util/E;)Ljava/util/OptionalDouble;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findAny()Lj$/util/F;

    move-result-object v0

    invoke-static {v0}, Lj$/util/I;->m(Lj$/util/F;)Ljava/util/OptionalInt;
...
.method public final synthetic findFirst()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findFirst()Lj$/util/F;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-direct {v1, p1}, Lj$/util/stream/N0;-><init>(Ljava/util/function/IntFunction;)V

    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->o(Lj$/util/stream/N0;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/P;

    move-result-object v0

    invoke-static {v0}, Lj$/util/O;->a(Lj$/util/P;)Ljava/util/PrimitiveIterator$OfInt;
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->d()Lj$/util/stream/F;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->k()Lj$/util/stream/o0;
...
.method public final synthetic max()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->max()Lj$/util/F;
...
.method public final synthetic min()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->min()Lj$/util/F;
...
.method public final synthetic noneMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->e()Z
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->reduce(Ljava/util/function/IntBinaryOperator;)Lj$/util/F;

    move-result-object p1

    invoke-static {p1}, Lj$/util/I;->m(Lj$/util/F;)Ljava/util/OptionalInt;
