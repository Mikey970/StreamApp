...
.method constructor <init>(Lj$/util/stream/c;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/v2;->t:J

    iput-wide p5, p0, Lj$/util/stream/v2;->u:J
...
.method static S0(Lj$/util/Spliterator$OfInt;JJJ)Lj$/util/Spliterator$OfInt;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/G3;-><init>(Lj$/util/Spliterator$OfInt;JJ)V
...
.method final H0(Lj$/util/Spliterator;Lj$/util/stream/c;Ljava/util/function/IntFunction;)Lj$/util/stream/G0;
    ...
    iget-wide v4, v9, Lj$/util/stream/v2;->t:J

    iget-wide v7, v9, Lj$/util/stream/v2;->u:J
    ...
    invoke-static {p2, v0, v10}, Lj$/util/stream/x0;->a0(Lj$/util/stream/x0;Lj$/util/Spliterator;Z)Lj$/util/stream/D0;
    ...
    iget-wide v1, v9, Lj$/util/stream/v2;->t:J

    iget-wide v3, v9, Lj$/util/stream/v2;->u:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/v2;->S0(Lj$/util/Spliterator$OfInt;JJJ)Lj$/util/Spliterator$OfInt;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/x0;->a0(Lj$/util/stream/x0;Lj$/util/Spliterator;Z)Lj$/util/stream/D0;
    ...
    iget-wide v7, v9, Lj$/util/stream/v2;->t:J

    iget-wide v11, v9, Lj$/util/stream/v2;->u:J
...
.method final I0(Lj$/util/stream/c;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v9, p0, Lj$/util/stream/v2;->t:J

    iget-wide p1, p0, Lj$/util/stream/v2;->u:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/z3;-><init>(Lj$/util/Spliterator$OfInt;JJ)V
    ...
    iget-wide v1, p0, Lj$/util/stream/v2;->t:J

    iget-wide v3, p0, Lj$/util/stream/v2;->u:J
    ...
    iget-wide v5, p0, Lj$/util/stream/v2;->t:J

    iget-wide v7, p0, Lj$/util/stream/v2;->u:J
