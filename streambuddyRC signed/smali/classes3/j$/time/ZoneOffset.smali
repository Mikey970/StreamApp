...
.method public static U(Lj$/time/temporal/TemporalAccessor;)Lj$/time/ZoneOffset;
    .locals 4
...
.method public static W(III)Lj$/time/ZoneOffset;
    .locals 4
...
.method public static X(I)Lj$/time/ZoneOffset;
    .locals 3
    ...
    sget-object p0, Lj$/time/ZoneOffset;->e:Lj$/util/concurrent/ConcurrentHashMap;

    .line 0
    iget-object v0, v2, Lj$/time/ZoneOffset;->c:Ljava/lang/String;
...
.method private static Y(Ljava/lang/CharSequence;IZ)I
    .locals 2
...
.method static Z(Ljava/io/DataInput;)Lj$/time/ZoneOffset;
    .locals 2
...
.method public static of(Ljava/lang/String;)Lj$/time/ZoneOffset;
    ...
    invoke-static {p0, v3, v1}, Lj$/time/ZoneOffset;->Y(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v3}, Lj$/time/ZoneOffset;->Y(Ljava/lang/CharSequence;IZ)I

    move-result v2

    invoke-static {p0, v5, v3}, Lj$/time/ZoneOffset;->Y(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v2, v1}, Lj$/time/ZoneOffset;->Y(Ljava/lang/CharSequence;IZ)I

    move-result v2

    invoke-static {p0, v4, v1}, Lj$/time/ZoneOffset;->Y(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v0, v1}, Lj$/time/ZoneOffset;->W(III)Lj$/time/ZoneOffset;
    ...
    :cond_9
    invoke-static {v0, v2, v3}, Lj$/time/ZoneOffset;->W(III)Lj$/time/ZoneOffset;
...
.method final S(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {p0, p1}, Lj$/time/ZoneOffset;->a0(Ljava/io/DataOutput;)V

    return-void
.end method

.method public final T(Lj$/time/ZoneOffset;)I
    .locals 1
...
.method public final getRules()Lj$/time/zone/ZoneRules;
    ...
    invoke-static {p0}, Lj$/time/zone/ZoneRules;->i(Lj$/time/ZoneOffset;)Lj$/time/zone/ZoneRules;
...
.method public final h(Lj$/time/temporal/r;)I
    ...
    .line 0
    invoke-virtual {p0, p1}, Lj$/time/ZoneOffset;->v(Lj$/time/temporal/r;)J
