...
.field private final f:Lj$/time/chrono/k;
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v6, v7}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v5}, Lj$/time/format/w;->e(C)V

    sget-object v8, Lj$/time/temporal/a;->DAY_OF_MONTH:Lj$/time/temporal/a;

    invoke-virtual {v0, v8, v7}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    sget-object v9, Lj$/time/format/E;->STRICT:Lj$/time/format/E;

    sget-object v10, Lj$/time/chrono/r;->d:Lj$/time/chrono/r;

    invoke-virtual {v0, v9, v10}, Lj$/time/format/w;->u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11}, Lj$/time/format/w;->q()V

    invoke-virtual {v11, v0}, Lj$/time/format/w;->a(Lj$/time/format/DateTimeFormatter;)V

    invoke-virtual {v11}, Lj$/time/format/w;->h()V

    invoke-virtual {v11, v9, v10}, Lj$/time/format/w;->u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11}, Lj$/time/format/w;->p()V
    ...
    invoke-virtual {v11, v12, v7}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v11, v14, v7}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v11, v15, v7}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v11, v9, v5}, Lj$/time/format/w;->u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7}, Lj$/time/format/w;->q()V

    invoke-virtual {v7, v0}, Lj$/time/format/w;->a(Lj$/time/format/DateTimeFormatter;)V

    invoke-virtual {v7}, Lj$/time/format/w;->s()V

    invoke-virtual {v7}, Lj$/time/format/w;->h()V

    invoke-virtual {v7}, Lj$/time/format/w;->t()V

    invoke-virtual {v7, v9, v10}, Lj$/time/format/w;->u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11}, Lj$/time/format/w;->n()V
    ...
    invoke-virtual {v0}, Lj$/time/format/w;->q()V

    const/4 v7, 0x4

    invoke-virtual {v0, v1, v7, v4, v2}, Lj$/time/format/w;->k(Lj$/time/temporal/r;IILj$/time/format/F;)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v7, v11}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    invoke-virtual {v0}, Lj$/time/format/w;->p()V

    invoke-virtual {v0}, Lj$/time/format/w;->h()V
    ...
    invoke-virtual {v0, v7, v11, v4, v2}, Lj$/time/format/w;->k(Lj$/time/temporal/r;IILj$/time/format/F;)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v2, v4}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v2, v3}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v9, v5}, Lj$/time/format/w;->u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v1, v4}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    const/4 v4, 0x2

    invoke-virtual {v0, v6, v4}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v8, v4}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    invoke-virtual {v0}, Lj$/time/format/w;->p()V

    invoke-virtual {v0}, Lj$/time/format/w;->s()V

    const-string v4, "+HHMMss"

    const-string v5, "Z"

    invoke-virtual {v0, v4, v5}, Lj$/time/format/w;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lj$/time/format/w;->q()V

    invoke-virtual {v3}, Lj$/time/format/w;->s()V

    invoke-virtual {v3}, Lj$/time/format/w;->p()V

    invoke-virtual {v3, v2, v0}, Lj$/time/format/w;->j(Lj$/time/temporal/a;Ljava/util/Map;)V

    const-string v0, ", "

    invoke-virtual {v3, v0}, Lj$/time/format/w;->f(Ljava/lang/String;)V

    invoke-virtual {v3}, Lj$/time/format/w;->o()V
    ...
    invoke-virtual {v3, v8, v4, v2, v0}, Lj$/time/format/w;->k(Lj$/time/temporal/r;IILj$/time/format/F;)Lj$/time/format/w;

    const/16 v0, 0x20

    invoke-virtual {v3, v0}, Lj$/time/format/w;->e(C)V

    invoke-virtual {v3, v6, v10}, Lj$/time/format/w;->j(Lj$/time/temporal/a;Ljava/util/Map;)V

    invoke-virtual {v3, v0}, Lj$/time/format/w;->e(C)V

    const/4 v4, 0x4

    invoke-virtual {v3, v1, v4}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    invoke-virtual {v3, v0}, Lj$/time/format/w;->e(C)V

    invoke-virtual {v3, v12, v2}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    const/16 v1, 0x3a

    invoke-virtual {v3, v1}, Lj$/time/format/w;->e(C)V

    invoke-virtual {v3, v14, v2}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v3, v1, v2}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v3, v0, v1}, Lj$/time/format/w;->g(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v0, Lj$/time/format/E;->SMART:Lj$/time/format/E;

    move-object/from16 v1, v16

    invoke-virtual {v3, v0, v1}, Lj$/time/format/w;->u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;

    return-void
.end method

.method constructor <init>(Lj$/time/format/f;Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/r;)V
    .locals 2
    ...
    check-cast p2, Lj$/time/format/C;

    iput-object p2, p0, Lj$/time/format/DateTimeFormatter;->c:Lj$/time/format/C;
    ...
    iput-object p2, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/format/E;

    iput-object p4, p0, Lj$/time/format/DateTimeFormatter;->f:Lj$/time/chrono/k;
...
.method private f(Ljava/lang/CharSequence;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {v4, v2, p1, v3}, Lj$/time/format/f;->q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v2, p1, v0}, Lj$/time/format/x;->t(Lj$/time/format/E;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
...
.method public static ofPattern(Ljava/lang/String;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, p0}, Lj$/time/format/w;->i(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0}, Lj$/time/format/w;->v(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
...
.method public static ofPattern(Ljava/lang/String;Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, p1}, Lj$/time/format/w;->v(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
...
.method public final a()Lj$/time/chrono/k;
    ...
    iget-object v0, p0, Lj$/time/format/DateTimeFormatter;->f:Lj$/time/chrono/k;
...
.method public final e(Ljava/lang/CharSequence;Lj$/time/d;)Ljava/lang/Object;
    .locals 5
...
.method public format(Lj$/time/temporal/TemporalAccessor;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {p1, v1, v0}, Lj$/time/format/f;->h(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    :try_end_1
