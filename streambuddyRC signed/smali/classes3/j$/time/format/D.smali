...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lj$/time/format/D;->g:Lj$/time/o;

    return-void
.end method

.method private B(Lj$/time/i;Lj$/time/o;)V
    .locals 4

    iget-object v0, p0, Lj$/time/format/D;->f:Lj$/time/i;
    ...
    iget-object p1, p0, Lj$/time/format/D;->g:Lj$/time/o;
    ...
    iget-object v0, p0, Lj$/time/format/D;->g:Lj$/time/o;
    ...
    :cond_4
    iput-object p1, p0, Lj$/time/format/D;->f:Lj$/time/i;

    :cond_5
    :goto_2
    iput-object p2, p0, Lj$/time/format/D;->g:Lj$/time/o;

    return-void
.end method

.method private E(Lj$/time/chrono/ChronoLocalDate;)V
    .locals 4
    ...
    iget-object v0, p0, Lj$/time/format/D;->c:Lj$/time/chrono/k;
...
.method private G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    .locals 6
...
.method private i(Lj$/time/temporal/TemporalAccessor;)V
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/r;)Z
...
.method private p()V
    ...
    invoke-direct {p0, v1}, Lj$/time/format/D;->s(Lj$/time/ZoneId;)V
    ...
    invoke-direct {p0, v0}, Lj$/time/format/D;->s(Lj$/time/ZoneId;)V
...
.method private s(Lj$/time/ZoneId;)V
    .locals 4
    ...
    invoke-static {v2, v3}, Lj$/time/Instant;->Q(J)Lj$/time/Instant;

    move-result-object v0

    iget-object v2, p0, Lj$/time/format/D;->c:Lj$/time/chrono/k;

    invoke-interface {v2, v0, p1}, Lj$/time/chrono/k;->I(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-direct {p0, v0}, Lj$/time/format/D;->E(Lj$/time/chrono/ChronoLocalDate;)V
    ...
    invoke-virtual {p1}, Lj$/time/i;->h0()I
    ...
    invoke-direct {p0, v1, v0, p1}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
...
.method private u(JJJJ)V
    ...
    invoke-static {p3, p4, v0, v1}, Lj$/jdk/internal/util/a;->i(JJ)J

    move-result-wide p3

    invoke-static {p1, p2, p3, p4}, Lj$/jdk/internal/util/a;->e(JJ)J

    move-result-wide p1

    const-wide/32 p3, 0x3b9aca00

    invoke-static {p5, p6, p3, p4}, Lj$/jdk/internal/util/a;->i(JJ)J
    ...
    invoke-static {p1, p2, p7, p8}, Lj$/jdk/internal/util/a;->e(JJ)J

    move-result-wide p1

    const-wide p3, 0x4e94914f0000L

    invoke-static {p1, p2, p3, p4}, Lj$/jdk/internal/util/a;->h(JJ)J

    move-result-wide p5

    long-to-int p6, p5

    invoke-static {p1, p2, p3, p4}, Lj$/jdk/internal/util/a;->g(JJ)J
    ...
    invoke-static {p6}, Lj$/time/o;->c(I)Lj$/time/o;

    move-result-object p2

    :goto_0
    invoke-direct {p0, p1, p2}, Lj$/time/format/D;->B(Lj$/time/i;Lj$/time/o;)V
    ...
    invoke-static {p2}, Lj$/time/o;->c(I)Lj$/time/o;
    ...
    invoke-static {p1, p3, p2, p4}, Lj$/time/i;->X(IIII)Lj$/time/i;
...
.method private x()V
    ...
    invoke-direct {p0, v1, v2, v5}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v2, v3}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 0
    invoke-static {v3, v4, v5, v6}, Lj$/jdk/internal/util/a;->i(JJ)J

    move-result-wide v3

    .line 0
    invoke-static {v3, v4, v7, v8}, Lj$/jdk/internal/util/a;->e(JJ)J
    ...
    invoke-direct {p0, v1, v2, v7}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v2, v9}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v2, v11}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v4, v1, v7}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v4, v1, v2}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v5 .. v13}, Lj$/time/format/D;->u(JJJJ)V
...
.method public final g(Lj$/time/temporal/r;)Z
    ...
    invoke-virtual {v0, p1}, Lj$/time/i;->g(Lj$/time/temporal/r;)Z
...
.method final n(Lj$/time/format/E;Ljava/util/Set;)V
    .locals 24
    ...
    .line 0
    invoke-direct/range {p0 .. p0}, Lj$/time/format/D;->p()V

    .line 0
    iget-object v0, v9, Lj$/time/format/D;->c:Lj$/time/chrono/k;

    iget-object v2, v9, Lj$/time/format/D;->d:Lj$/time/format/E;

    invoke-interface {v0, v1, v2}, Lj$/time/chrono/k;->G(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v0

    invoke-direct {v9, v0}, Lj$/time/format/D;->E(Lj$/time/chrono/ChronoLocalDate;)V

    .line 0
    invoke-direct/range {p0 .. p0}, Lj$/time/format/D;->x()V
    ...
    invoke-interface {v4, v1, v9, v5}, Lj$/time/temporal/r;->v(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/E;)Lj$/time/temporal/TemporalAccessor;

    move-result-object v5

    if-eqz v5, :cond_8

    instance-of v2, v5, Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-interface {v5}, Lj$/time/chrono/ChronoZonedDateTime;->t()Lj$/time/ZoneId;

    move-result-object v2

    iput-object v2, v9, Lj$/time/format/D;->b:Lj$/time/ZoneId;
    ...
    :goto_1
    invoke-interface {v5}, Lj$/time/chrono/ChronoZonedDateTime;->D()Lj$/time/chrono/ChronoLocalDateTime;
    ...
    :cond_4
    :goto_2
    instance-of v2, v5, Lj$/time/chrono/ChronoLocalDateTime;

    if-eqz v2, :cond_5

    check-cast v5, Lj$/time/chrono/ChronoLocalDateTime;

    invoke-interface {v5}, Lj$/time/chrono/ChronoLocalDateTime;->b()Lj$/time/i;

    move-result-object v2

    sget-object v3, Lj$/time/o;->d:Lj$/time/o;

    invoke-direct {v9, v2, v3}, Lj$/time/format/D;->B(Lj$/time/i;Lj$/time/o;)V

    invoke-interface {v5}, Lj$/time/chrono/ChronoLocalDateTime;->c()Lj$/time/chrono/ChronoLocalDate;

    move-result-object v2

    invoke-direct {v9, v2}, Lj$/time/format/D;->E(Lj$/time/chrono/ChronoLocalDate;)V

    goto :goto_3

    :cond_5
    instance-of v2, v5, Lj$/time/chrono/ChronoLocalDate;

    if-eqz v2, :cond_6

    check-cast v5, Lj$/time/chrono/ChronoLocalDate;

    invoke-direct {v9, v5}, Lj$/time/format/D;->E(Lj$/time/chrono/ChronoLocalDate;)V

    goto :goto_3

    :cond_6
    instance-of v2, v5, Lj$/time/i;

    if-eqz v2, :cond_7

    check-cast v5, Lj$/time/i;

    sget-object v2, Lj$/time/o;->d:Lj$/time/o;

    invoke-direct {v9, v5, v2}, Lj$/time/format/D;->B(Lj$/time/i;Lj$/time/o;)V
    ...
    :cond_b
    :goto_4
    iget-object v0, v9, Lj$/time/format/D;->f:Lj$/time/i;
    ...
    invoke-direct {v9, v0, v3, v1}, Lj$/time/format/D;->G(Lj$/time/temporal/a;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v8}, Lj$/time/format/D;->u(JJJJ)V
    ...
    invoke-interface {v2}, Lj$/time/temporal/r;->r()Z
    ...
    iget-object v1, v9, Lj$/time/format/D;->f:Lj$/time/i;

    invoke-interface {v0, v1}, Lj$/time/chrono/ChronoLocalDate;->y(Lj$/time/i;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    iget-object v0, v9, Lj$/time/format/D;->g:Lj$/time/o;
    ...
    iget-object v2, v9, Lj$/time/format/D;->g:Lj$/time/o;

    invoke-interface {v0, v2}, Lj$/time/chrono/ChronoLocalDate;->j(Lj$/time/o;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v0

    iput-object v0, v9, Lj$/time/format/D;->e:Lj$/time/chrono/ChronoLocalDate;

    iput-object v1, v9, Lj$/time/format/D;->g:Lj$/time/o;
    ...
    iget-object v2, v9, Lj$/time/format/D;->f:Lj$/time/i;

    invoke-interface {v1, v2}, Lj$/time/chrono/ChronoLocalDate;->y(Lj$/time/i;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    :goto_e
    invoke-interface {v0}, Lj$/time/chrono/ChronoZonedDateTime;->P()J
...
.method public final synthetic r(Lj$/time/temporal/r;)Lj$/time/temporal/w;
    .locals 0
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lj$/time/format/D;->f:Lj$/time/i;
...
.method public final z(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lj$/time/format/D;->c:Lj$/time/chrono/k;
    ...
    iget-object p1, p0, Lj$/time/format/D;->f:Lj$/time/i;
