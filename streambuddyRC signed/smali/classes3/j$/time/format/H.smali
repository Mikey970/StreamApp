...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/H;->d:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lj$/time/format/H;->e:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lj$/time/format/H;->f:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lj$/time/format/H;->g:Ljava/util/Map;
    ...
    sget-object v2, Lj$/time/format/H;->d:Ljava/util/Map;
    ...
    sget-object v2, Lj$/time/format/H;->e:Ljava/util/Map;
    ...
    sget-object v3, Lj$/time/format/H;->f:Ljava/util/Map;
    ...
    sget-object v2, Lj$/time/format/H;->g:Ljava/util/Map;
...
.method public static a(Ljava/lang/String;Ljava/util/Locale;)Ljava/lang/String;
    ...
    sget-object v0, Lj$/time/format/H;->d:Ljava/util/Map;
    ...
    sget-object p0, Lj$/time/format/H;->f:Ljava/util/Map;
    ...
    :cond_1
    sget-object p0, Lj$/time/format/H;->e:Ljava/util/Map;
