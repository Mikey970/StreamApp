...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->average()Lj$/util/E;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->findAny()Lj$/util/G;

    move-result-object v0

    invoke-static {v0}, Lj$/util/I;->n(Lj$/util/G;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->findFirst()Lj$/util/G;
...
.method public final flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/o0;->c(Lj$/util/stream/a;)Lj$/util/stream/o0;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->iterator()Lj$/util/U;
...
.method public final synthetic map(Ljava/util/function/LongUnaryOperator;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/o0;->b()Lj$/util/stream/o0;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->max()Lj$/util/G;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->min()Lj$/util/G;
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/o0;->reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/G;

    move-result-object p1

    invoke-static {p1}, Lj$/util/I;->n(Lj$/util/G;)Ljava/util/OptionalLong;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-static {v0}, Lj$/util/d0;->a(Lj$/util/e0;)Ljava/util/Spliterator$OfLong;
...
.method public final summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/o0;->summaryStatistics()Lj$/util/C;
