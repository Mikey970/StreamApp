...
.method private w(Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    .locals 3
    ...
    iget-object v1, p0, Lj$/time/format/w;->c:Ljava/util/List;

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lj$/time/format/f;-><init>(Ljava/util/List;Z)V

    new-instance v1, Lj$/time/format/DateTimeFormatter;

    sget-object v2, Lj$/time/format/C;->a:Lj$/time/format/C;

    invoke-direct {v1, v0, p1, p2, p3}, Lj$/time/format/DateTimeFormatter;-><init>(Lj$/time/format/f;Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/r;)V
...
.method public final i(Ljava/lang/String;)V
    ...
    .line 0
    iget-object v9, p0, Lj$/time/format/w;->a:Lj$/time/format/w;

    iput v1, v9, Lj$/time/format/w;->e:I

    const/16 v1, 0x20

    iput-char v1, v9, Lj$/time/format/w;->f:C

    iput v10, v9, Lj$/time/format/w;->g:I
    ...
    .line 0
    invoke-static {v0, v1}, Lj$/time/b;->a(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v1, v13, v2}, Lj$/time/format/w;->k(Lj$/time/temporal/r;IILj$/time/format/F;)Lj$/time/format/w;
    ...
    invoke-direct {v3, v2, v1, v1, v1}, Lj$/time/format/t;-><init>(CIII)V
    ...
    .line 0
    invoke-static {v3, v5}, Lj$/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v3, v1}, Lj$/time/format/q;-><init>(Lj$/time/temporal/r;Lj$/time/LocalDate;)V

    invoke-direct {p0, v2}, Lj$/time/format/w;->l(Lj$/time/format/k;)V
    ...
    :cond_18
    invoke-virtual {p0, v3, v1}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {p0, v2, v1, v1, v0}, Lj$/time/format/w;->b(Lj$/time/temporal/a;IIZ)V
    ...
    :goto_a
    invoke-direct {p0, v3}, Lj$/time/format/w;->l(Lj$/time/format/k;)V
    ...
    :cond_25
    :goto_b
    sget-object v1, Lj$/time/format/G;->SHORT:Lj$/time/format/G;
    ...
    invoke-direct {v2, v3, v1, v5}, Lj$/time/format/s;-><init>(Lj$/time/temporal/r;Lj$/time/format/G;Lj$/time/format/B;)V

    invoke-direct {p0, v2}, Lj$/time/format/w;->d(Lj$/time/format/g;)I
    ...
    invoke-direct {v1, v3, v4, v5, v2}, Lj$/time/format/k;-><init>(Lj$/time/temporal/r;IILj$/time/format/F;)V

    invoke-direct {p0, v1}, Lj$/time/format/w;->l(Lj$/time/format/k;)V

    goto/16 :goto_1a

    .line 0
    :cond_27
    invoke-virtual {p0, v3, v9}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    :goto_e
    invoke-virtual {p0, v3, v1, v5, v2}, Lj$/time/format/w;->k(Lj$/time/temporal/r;IILj$/time/format/F;)Lj$/time/format/w;
    ...
    invoke-direct {v2, v1, v0}, Lj$/time/format/v;-><init>(Lj$/time/format/G;Z)V
    ...
    invoke-direct {v1, v2, v3}, Lj$/time/format/u;-><init>(Lj$/time/temporal/t;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1, v4}, Lj$/time/format/v;-><init>(Lj$/time/format/G;Z)V
    ...
    sget-object v2, Lj$/time/format/G;->SHORT:Lj$/time/format/G;
    ...
    invoke-direct {v2, v0, v1}, Lj$/time/format/j;-><init>(ILjava/lang/Object;)V
    ...
    if-gt v1, v10, :cond_3c

    sget-object v2, Lj$/time/format/l;->d:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v2}, Lj$/time/format/w;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_18
    invoke-virtual {p0, v1, v3}, Lj$/time/format/w;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v2, v1, v1, v9}, Lj$/time/format/t;-><init>(CIII)V
    ...
    invoke-direct {v3, v2, v1, v1, v5}, Lj$/time/format/t;-><init>(CIII)V
    ...
    invoke-virtual {p0, v5}, Lj$/time/format/w;->e(C)V
    ...
    invoke-virtual {p0, v1}, Lj$/time/format/w;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lj$/time/format/w;->p()V
    ...
    iget-object v2, v2, Lj$/time/format/w;->b:Lj$/time/format/w;
    ...
    invoke-virtual {p0, v2}, Lj$/time/format/w;->e(C)V
...
.method public final j(Lj$/time/temporal/a;Ljava/util/Map;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Lj$/time/format/s;-><init>(Lj$/time/temporal/r;Lj$/time/format/G;Lj$/time/format/B;)V
...
.method public final k(Lj$/time/temporal/r;IILj$/time/format/F;)Lj$/time/format/w;
    .locals 2
    ...
    invoke-virtual {p0, p1, p3}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lj$/time/format/k;-><init>(Lj$/time/temporal/r;IILj$/time/format/F;)V
    ...
    .line 0
    invoke-static {p2, p3}, Lj$/time/b;->a(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 0
    invoke-static {p3, p2}, Lj$/time/b;->a(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final m(Lj$/time/temporal/r;I)V
    ...
    invoke-direct {v0, p1, p2, p2, v1}, Lj$/time/format/k;-><init>(Lj$/time/temporal/r;IILj$/time/format/F;)V
    ...
    .line 0
    invoke-static {v0, p2}, Lj$/time/b;->a(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final n()V
    ...
    invoke-direct {v0, v1, v2}, Lj$/time/format/u;-><init>(Lj$/time/temporal/t;Ljava/lang/String;)V
...
.method final u(Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    .locals 1
    ...
    invoke-direct {p0, v0, p1, p2}, Lj$/time/format/w;->w(Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
...
.method public final v(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-direct {p0, p1, v0, v1}, Lj$/time/format/w;->w(Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
