...
.method final h()Lj$/time/chrono/k;
    ...
    iget-object v0, v0, Lj$/time/format/D;->c:Lj$/time/chrono/k;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/time/format/x;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/k;
...
.method final o(Lj$/time/temporal/r;JII)I
    .locals 2
...
.method final r()V
    ...
    iget-object v3, v2, Lj$/time/format/D;->a:Ljava/util/Map;

    iget-object v4, v1, Lj$/time/format/D;->a:Ljava/util/Map;
    ...
    iget-object v1, v1, Lj$/time/format/D;->c:Lj$/time/chrono/k;

    iput-object v1, v2, Lj$/time/format/D;->c:Lj$/time/chrono/k;
...
.method final t(Lj$/time/format/E;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {p0}, Lj$/time/format/x;->h()Lj$/time/chrono/k;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/D;->c:Lj$/time/chrono/k;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/D;->n(Lj$/time/format/E;Ljava/util/Set;)V
