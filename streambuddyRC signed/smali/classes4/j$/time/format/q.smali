...
.method private constructor <init>(Lj$/time/temporal/r;IIILj$/time/chrono/ChronoLocalDate;I)V
    .locals 6
...
.method constructor <init>(Lj$/time/temporal/r;Lj$/time/LocalDate;)V
    ...
    invoke-direct/range {v0 .. v6}, Lj$/time/format/q;-><init>(Lj$/time/temporal/r;IIILj$/time/chrono/ChronoLocalDate;I)V
...
.method final b(Lj$/time/format/z;J)J
    ...
    invoke-interface {p1, v2}, Lj$/time/chrono/k;->p(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/ChronoLocalDate;
...
.method final d(Lj$/time/format/x;JII)I
    ...
    invoke-interface {v1, v0}, Lj$/time/chrono/k;->p(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/k;->a:Lj$/time/temporal/r;

    invoke-interface {v0, v1}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/r;)I
...
.method final e()Lj$/time/format/k;
    ...
    invoke-direct/range {v2 .. v8}, Lj$/time/format/q;-><init>(Lj$/time/temporal/r;IIILj$/time/chrono/ChronoLocalDate;I)V
