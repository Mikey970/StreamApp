...
.method constructor <init>(CIIII)V
    ...
    invoke-direct/range {v0 .. v5}, Lj$/time/format/k;-><init>(Lj$/time/temporal/r;IILj$/time/format/F;I)V
...
.method private g(Ljava/util/Locale;)Lj$/time/format/k;
    ...
    invoke-virtual {v1, v2, v3}, Lj$/time/c;->N(J)Lj$/time/c;
    ...
    invoke-static {v0, p1}, Lj$/time/temporal/y;->g(Lj$/time/c;I)Lj$/time/temporal/y;
    ...
    invoke-virtual {p1}, Lj$/time/temporal/y;->j()Lj$/time/temporal/r;
    ...
    :cond_1
    invoke-virtual {p1}, Lj$/time/temporal/y;->d()Lj$/time/temporal/r;
    ...
    :cond_2
    invoke-virtual {p1}, Lj$/time/temporal/y;->h()Lj$/time/temporal/r;
    ...
    invoke-direct {p1, v1, v0, v2}, Lj$/time/format/q;-><init>(Lj$/time/temporal/r;Lj$/time/LocalDate;I)V
    ...
    :cond_5
    invoke-virtual {p1}, Lj$/time/temporal/y;->i()Lj$/time/temporal/r;
...
.method public final q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/format/k;->q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
