...
.method static E()J
    ...
    :goto_0
    sget-object v4, Lj$/time/chrono/x;->e:[Lj$/time/chrono/x;
    ...
    iget-object v2, v4, Lj$/time/chrono/x;->b:Lj$/time/LocalDate;
...
.method public static G()[Lj$/time/chrono/x;
    .locals 2
...
.method static i(Lj$/time/LocalDate;)Lj$/time/chrono/x;
    .locals 3

    sget-object v0, Lj$/time/chrono/w;->d:Lj$/time/LocalDate;

    invoke-virtual {p0, v0}, Lj$/time/LocalDate;->U(Lj$/time/LocalDate;)Z
    ...
    iget-object v2, v1, Lj$/time/chrono/x;->b:Lj$/time/LocalDate;
...
.method static n()Lj$/time/chrono/x;
    .locals 2
...
.method public static u(I)Lj$/time/chrono/x;
    .locals 3
...
.method static x()J
    ...
    invoke-virtual {v6}, Lj$/time/LocalDate;->K()I

    move-result v6

    iget-object v7, v5, Lj$/time/chrono/x;->b:Lj$/time/LocalDate;

    invoke-virtual {v7}, Lj$/time/LocalDate;->T()I
    ...
    invoke-virtual {v5}, Lj$/time/chrono/x;->s()Lj$/time/chrono/x;
...
.method final p()Lj$/time/LocalDate;
    .locals 1
...
.method public final r(Lj$/time/temporal/r;)Lj$/time/temporal/w;
    ...
    invoke-virtual {p1, v0}, Lj$/time/chrono/u;->H(Lj$/time/temporal/a;)Lj$/time/temporal/w;
...
.method final s()Lj$/time/chrono/x;
    .locals 1
    ...
    invoke-static {v0}, Lj$/time/chrono/x;->u(I)Lj$/time/chrono/x;
