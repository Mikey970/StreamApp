...
.method constructor <init>(Lj$/util/stream/c;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/g3;->h(II)I
    ...
    invoke-virtual {p0}, Lj$/util/stream/c;->J0()Z
...
.method private L0(I)Lj$/util/Spliterator;
    .locals 7
    ...
    invoke-virtual {v2}, Lj$/util/stream/c;->J0()Z
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/g3;->v(I)Z
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/c;->I0(Lj$/util/stream/c;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v4, v0}, Lj$/util/stream/g3;->h(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/g3;->h(II)I
...
# virtual methods
.method final A0(Ljava/util/function/IntFunction;)Lj$/util/stream/G0;
    .locals 3
    ...
    invoke-direct {v0, v2}, Lj$/util/stream/c;->L0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/c;->H0(Lj$/util/Spliterator;Lj$/util/stream/c;Ljava/util/function/IntFunction;)Lj$/util/stream/G0;
    ...
    :cond_0
    invoke-direct {p0, v2}, Lj$/util/stream/c;->L0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/c;->y0(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/G0;
...
.method abstract B0(Lj$/util/stream/x0;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/G0;
.end method

.method abstract C0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z
.end method

.method abstract D0()Lj$/util/stream/h3;
.end method

.method final E0()Lj$/util/stream/h3;
    .locals 2
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/util/stream/c;->D0()Lj$/util/stream/h3;
...
.method final synthetic G0()Lj$/util/Spliterator;
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lj$/util/stream/c;->L0(I)Lj$/util/Spliterator;
...
.method H0(Lj$/util/Spliterator;Lj$/util/stream/c;Ljava/util/function/IntFunction;)Lj$/util/stream/G0;
    .locals 0
...
.method I0(Lj$/util/stream/c;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    invoke-virtual {p0, p2, p1, v0}, Lj$/util/stream/c;->H0(Lj$/util/Spliterator;Lj$/util/stream/c;Ljava/util/function/IntFunction;)Lj$/util/stream/G0;
...
.method abstract K0(ILj$/util/stream/r2;)Lj$/util/stream/r2;
.end method

.method final M0()Lj$/util/Spliterator;
    .locals 3
...
.method abstract N0(Lj$/util/stream/x0;Lj$/util/stream/a;Z)Lj$/util/Spliterator;
.end method

.method final O0(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    .line 0
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/c;->N0(Lj$/util/stream/x0;Lj$/util/stream/a;Z)Lj$/util/Spliterator;
...
.method final d0(Lj$/util/Spliterator;Lj$/util/stream/r2;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/c;->e0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z

    :goto_0
    return-void
.end method

.method final e0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z
    .locals 3
    ...
    invoke-virtual {v0, p1, p2}, Lj$/util/stream/c;->C0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    .line 0
    invoke-virtual {p0, p0, v2, v0}, Lj$/util/stream/c;->N0(Lj$/util/stream/x0;Lj$/util/stream/a;Z)Lj$/util/Spliterator;
...
.method final w0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Lj$/util/stream/r2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/c;->x0(Lj$/util/stream/r2;)Lj$/util/stream/r2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/c;->d0(Lj$/util/Spliterator;Lj$/util/stream/r2;)V

    return-object p2
.end method

.method final x0(Lj$/util/stream/r2;)Lj$/util/stream/r2;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/c;->K0(ILj$/util/stream/r2;)Lj$/util/stream/r2;
...
.method final y0(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/G0;
    .locals 2
    ...
    .line 0
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/c;->B0(Lj$/util/stream/x0;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/G0;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/x0;->t0(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lj$/util/stream/c;->w0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Lj$/util/stream/r2;
...
.method final z0(Lj$/util/stream/R3;)Ljava/lang/Object;
    .locals 1
    ...
    .line 0
    invoke-interface {p1}, Lj$/util/stream/R3;->i()I
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/R3;->w(Lj$/util/stream/x0;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/R3;->z(Lj$/util/stream/x0;Lj$/util/Spliterator;)Ljava/lang/Object;
