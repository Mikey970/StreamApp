...
.method constructor <init>(Lj$/util/stream/B2;Lj$/util/Spliterator;)V
    ...
    iget-object p2, p1, Lj$/util/stream/B2;->j:Lj$/util/stream/c;

    iput-object p2, p0, Lj$/util/stream/B2;->j:Lj$/util/stream/c;
...
.method constructor <init>(Lj$/util/stream/c;Lj$/util/stream/c;Lj$/util/Spliterator;Ljava/util/function/IntFunction;JJ)V
    ...
    iput-object p1, p0, Lj$/util/stream/B2;->j:Lj$/util/stream/c;
...
.method protected final a()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lj$/util/stream/B2;->j:Lj$/util/stream/c;

    iget v1, v1, Lj$/util/stream/c;->j:I

    invoke-virtual {v0, v1}, Lj$/util/stream/g3;->z(I)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lj$/util/stream/B2;->j:Lj$/util/stream/c;

    iget-object v1, p0, Lj$/util/stream/f;->b:Lj$/util/Spliterator;

    invoke-virtual {v0, v1}, Lj$/util/stream/c;->h0(Lj$/util/Spliterator;)J
    ...
    iget-object v1, p0, Lj$/util/stream/B2;->k:Ljava/util/function/IntFunction;

    invoke-virtual {v0, v2, v3, v1}, Lj$/util/stream/x0;->t0(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;
    ...
    invoke-virtual {v2}, Lj$/util/stream/x0;->n0()I

    move-result v2

    invoke-virtual {v1, v2, v0}, Lj$/util/stream/c;->K0(ILj$/util/stream/r2;)Lj$/util/stream/r2;

    move-result-object v1

    iget-object v2, p0, Lj$/util/stream/f;->a:Lj$/util/stream/x0;

    invoke-virtual {v2, v1}, Lj$/util/stream/x0;->x0(Lj$/util/stream/r2;)Lj$/util/stream/r2;

    move-result-object v1

    iget-object v3, p0, Lj$/util/stream/f;->b:Lj$/util/Spliterator;

    invoke-virtual {v2, v3, v1}, Lj$/util/stream/x0;->e0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z
    ...
    iget-object v4, p0, Lj$/util/stream/B2;->k:Ljava/util/function/IntFunction;

    invoke-virtual {v0, v2, v3, v4}, Lj$/util/stream/x0;->t0(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;

    move-result-object v0

    iget-wide v2, p0, Lj$/util/stream/B2;->l:J
    ...
    iget-object v2, p0, Lj$/util/stream/B2;->j:Lj$/util/stream/c;

    iget-object v3, p0, Lj$/util/stream/f;->a:Lj$/util/stream/x0;

    invoke-virtual {v3}, Lj$/util/stream/x0;->n0()I

    move-result v3

    invoke-virtual {v2, v3, v0}, Lj$/util/stream/c;->K0(ILj$/util/stream/r2;)Lj$/util/stream/r2;

    move-result-object v2

    iget-object v3, p0, Lj$/util/stream/f;->a:Lj$/util/stream/x0;

    invoke-virtual {v3, v2}, Lj$/util/stream/x0;->x0(Lj$/util/stream/r2;)Lj$/util/stream/r2;

    move-result-object v2

    iget-object v4, p0, Lj$/util/stream/f;->b:Lj$/util/Spliterator;

    invoke-virtual {v3, v4, v2}, Lj$/util/stream/x0;->e0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z
    ...
    invoke-virtual {v2, v3, v0}, Lj$/util/stream/x0;->w0(Lj$/util/Spliterator;Lj$/util/stream/r2;)Lj$/util/stream/r2;
    ...
    iput-wide v2, p0, Lj$/util/stream/B2;->n:J
...
.method protected final h()V
    ...
    invoke-virtual {p0}, Lj$/util/stream/B2;->l()Lj$/util/stream/b1;
...
.method protected final l()Lj$/util/stream/b1;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/stream/x0;->g0(Lj$/util/stream/h3;)Lj$/util/stream/b1;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-wide v6, v0, Lj$/util/stream/B2;->n:J

    iget-object v0, p0, Lj$/util/stream/f;->e:Lj$/util/stream/f;

    check-cast v0, Lj$/util/stream/B2;

    iget-wide v8, v0, Lj$/util/stream/B2;->n:J

    add-long/2addr v6, v8

    iput-wide v6, p0, Lj$/util/stream/B2;->n:J

    iget-boolean v0, p0, Lj$/util/stream/d;->i:Z

    if-eqz v0, :cond_1

    iput-wide v4, p0, Lj$/util/stream/B2;->n:J
    ...
    check-cast v3, Lj$/util/stream/B2;
    ...
    check-cast v6, Lj$/util/stream/B2;

    invoke-virtual {v6}, Lj$/util/stream/d;->c()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lj$/util/stream/G0;

    invoke-static {v0, v3, v6}, Lj$/util/stream/x0;->c0(Lj$/util/stream/h3;Lj$/util/stream/G0;Lj$/util/stream/G0;)Lj$/util/stream/I0;
    ...
    .line 0
    iget-wide v7, p0, Lj$/util/stream/B2;->m:J

    cmp-long v0, v7, v4

    if-ltz v0, :cond_5

    invoke-interface {v6}, Lj$/util/stream/G0;->count()J

    move-result-wide v7

    iget-wide v9, p0, Lj$/util/stream/B2;->l:J

    iget-wide v11, p0, Lj$/util/stream/B2;->m:J
    ...
    :cond_5
    iget-wide v7, p0, Lj$/util/stream/B2;->n:J

    :goto_5
    move-wide v9, v7

    iget-wide v7, p0, Lj$/util/stream/B2;->l:J

    iget-object v11, p0, Lj$/util/stream/B2;->k:Ljava/util/function/IntFunction;

    invoke-interface/range {v6 .. v11}, Lj$/util/stream/G0;->g(JJLjava/util/function/IntFunction;)Lj$/util/stream/G0;
    ...
    .line 0
    iget-wide v3, p0, Lj$/util/stream/B2;->l:J

    iget-wide v5, p0, Lj$/util/stream/B2;->m:J
    ...
    :cond_9
    invoke-direct {p0, v3, v4}, Lj$/util/stream/B2;->k(J)J
    ...
    check-cast v7, Lj$/util/stream/B2;

    if-eqz v7, :cond_b

    invoke-direct {v7, v3, v4}, Lj$/util/stream/B2;->k(J)J
