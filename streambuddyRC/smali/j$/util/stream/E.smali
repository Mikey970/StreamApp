...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->average()Lj$/util/E;
...
.method public final synthetic findAny()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->findAny()Lj$/util/E;
...
.method public final synthetic findFirst()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->findFirst()Lj$/util/E;
...
.method public final flatMap(Ljava/util/function/DoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/F;->c(Lj$/util/stream/a;)Lj$/util/stream/F;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->iterator()Lj$/util/L;

    move-result-object v0

    invoke-static {v0}, Lj$/util/K;->a(Lj$/util/L;)Ljava/util/PrimitiveIterator$OfDouble;
...
.method public final synthetic max()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->max()Lj$/util/E;
...
.method public final synthetic min()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->min()Lj$/util/E;
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/F;->reduce(Ljava/util/function/DoubleBinaryOperator;)Lj$/util/E;

    move-result-object p1

    invoke-static {p1}, Lj$/util/I;->l(Lj$/util/E;)Ljava/util/OptionalDouble;
...
.method public final summaryStatistics()Ljava/util/DoubleSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->summaryStatistics()Lj$/util/i;
