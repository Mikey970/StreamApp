...
.method public final synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/util/stream/k;->a(Ljava/util/stream/Collector;)Lj$/util/stream/k;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->f(Lj$/util/stream/k;)Ljava/lang/Object;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findAny()Lj$/util/D;

    move-result-object v0

    invoke-static {v0}, Lj$/util/I;->k(Lj$/util/D;)Ljava/util/Optional;
...
.method public final synthetic findFirst()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findFirst()Lj$/util/D;
...
.method public final synthetic flatMap(Ljava/util/function/Function;)Ljava/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/x0;->m0(Ljava/util/function/Function;)Lj$/util/stream/a;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->c(Lj$/util/stream/a;)Lj$/util/stream/Stream;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->y(Lj$/util/stream/a;)Lj$/util/stream/F;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->r(Lj$/util/stream/a;)Lj$/util/stream/IntStream;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->m(Lj$/util/stream/a;)Lj$/util/stream/o0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToDouble(Ljava/util/function/ToDoubleFunction;)Lj$/util/stream/F;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToLong(Ljava/util/function/ToLongFunction;)Lj$/util/stream/o0;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->max(Ljava/util/Comparator;)Lj$/util/D;

    move-result-object p1

    invoke-static {p1}, Lj$/util/I;->k(Lj$/util/D;)Ljava/util/Optional;
...
.method public final synthetic min(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->min(Ljava/util/Comparator;)Lj$/util/D;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->reduce(Ljava/util/function/BinaryOperator;)Lj$/util/D;
