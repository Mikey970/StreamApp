...
# direct methods
.method constructor <init>(Lj$/time/temporal/r;Lj$/time/format/G;Lj$/time/format/B;)V
    .locals 0
...
.method public final h(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual/range {v2 .. v8}, Lj$/time/format/B;->e(Lj$/time/chrono/k;Lj$/time/temporal/r;JLj$/time/format/G;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/B;->f(Lj$/time/temporal/r;JLj$/time/format/G;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/k;-><init>(Lj$/time/temporal/r;IILj$/time/format/F;)V
    ...
    .line 0
    invoke-virtual {v0, p1, p2}, Lj$/time/format/k;->h(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
...
.method public final q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    :goto_0
    invoke-virtual {p1}, Lj$/time/format/x;->h()Lj$/time/chrono/k;

    move-result-object v8

    iget-object v2, v0, Lj$/time/format/s;->c:Lj$/time/format/B;

    iget-object v9, v0, Lj$/time/format/s;->a:Lj$/time/temporal/r;

    if-eqz v8, :cond_2

    sget-object v3, Lj$/time/chrono/r;->d:Lj$/time/chrono/r;
    ...
    invoke-virtual {v2, v8, v9, v1, v3}, Lj$/time/format/B;->g(Lj$/time/chrono/k;Lj$/time/temporal/r;Lj$/time/format/G;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual {v2, v9, v1, v3}, Lj$/time/format/B;->h(Lj$/time/temporal/r;Lj$/time/format/G;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    iget-object v2, v0, Lj$/time/format/s;->a:Lj$/time/temporal/r;
    ...
    invoke-interface {v8}, Lj$/time/chrono/k;->J()Ljava/util/List;
    ...
    check-cast v9, Lj$/time/chrono/l;
    ...
    invoke-interface {v9}, Lj$/time/chrono/l;->getValue()I
    ...
    invoke-direct {v1, v2, v4, v5, v3}, Lj$/time/format/k;-><init>(Lj$/time/temporal/r;IILj$/time/format/F;)V
    ...
    .line 0
    invoke-virtual {v1, p1, p2, v7}, Lj$/time/format/k;->q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
