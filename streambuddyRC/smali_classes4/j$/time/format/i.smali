...
# virtual methods
.method public final h(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    .locals 16
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/z;->e(Lj$/time/temporal/r;)Ljava/lang/Long;
    ...
    invoke-interface {v3, v4}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/r;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/TemporalAccessor;->v(Lj$/time/temporal/r;)J
    ...
    :goto_1
    invoke-virtual {v4, v1, v2}, Lj$/time/temporal/a;->Q(J)I
    ...
    invoke-static {v5, v6, v7, v8}, Lj$/jdk/internal/util/a;->h(JJ)J

    move-result-wide v9

    add-long/2addr v9, v11

    invoke-static {v5, v6, v7, v8}, Lj$/jdk/internal/util/a;->g(JJ)J
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->Y(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v5}, Lj$/time/LocalDateTime;->S()I
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->Y(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->S()I
    ...
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->T()I
...
.method public final q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v1}, Lj$/time/format/w;->a(Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-virtual {v0, v3}, Lj$/time/format/w;->e(C)V

    sget-object v4, Lj$/time/temporal/a;->MINUTE_OF_HOUR:Lj$/time/temporal/a;

    invoke-virtual {v0, v4, v2}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v3}, Lj$/time/format/w;->e(C)V

    sget-object v3, Lj$/time/temporal/a;->SECOND_OF_MINUTE:Lj$/time/temporal/a;

    invoke-virtual {v0, v3, v2}, Lj$/time/format/w;->m(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v7, v2, v5, v8}, Lj$/time/format/w;->b(Lj$/time/temporal/a;IIZ)V
    ...
    invoke-virtual {v0, v5}, Lj$/time/format/w;->v(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/f;->q(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v5, v0}, Lj$/time/format/x;->j(Lj$/time/temporal/a;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v1}, Lj$/time/format/x;->j(Lj$/time/temporal/a;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v4}, Lj$/time/format/x;->j(Lj$/time/temporal/a;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v3}, Lj$/time/format/x;->j(Lj$/time/temporal/a;)Ljava/lang/Long;

    move-result-object v3

    invoke-virtual {v5, v7}, Lj$/time/format/x;->j(Lj$/time/temporal/a;)Ljava/lang/Long;
    ...
    invoke-static {v10, v11, v2, v3}, Lj$/jdk/internal/util/a;->i(JJ)J
