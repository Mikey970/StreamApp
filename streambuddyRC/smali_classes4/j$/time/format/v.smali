...
.method constructor <init>(Lj$/time/format/G;Z)V
    ...
    invoke-direct {p0, v0, v1}, Lj$/time/format/u;-><init>(Lj$/time/temporal/t;Ljava/lang/String;)V

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lj$/time/format/v;->g:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lj$/time/format/v;->h:Ljava/util/Map;
...
.method protected final a(Lj$/time/format/x;)Lj$/time/format/o;
    ...
    iget-object v2, p0, Lj$/time/format/v;->g:Ljava/util/Map;

    goto :goto_0

    :cond_1
    iget-object v2, p0, Lj$/time/format/v;->h:Ljava/util/Map;
...
.method public final h(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/r;)Z
    ...
    invoke-interface {v3, v7}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/r;)Z

    move-result v8

    if-eqz v8, :cond_2

    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->v(Lj$/time/temporal/r;)J

    move-result-wide v8

    invoke-static {v8, v9}, Lj$/time/LocalDate;->Z(J)Lj$/time/LocalDate;

    move-result-object v5

    invoke-interface {v3, v7}, Lj$/time/temporal/TemporalAccessor;->v(Lj$/time/temporal/r;)J

    move-result-wide v7

    invoke-static {v7, v8}, Lj$/time/i;->Y(J)Lj$/time/i;

    move-result-object v3

    .line 0
    invoke-static {v5, v3}, Lj$/time/LocalDateTime;->X(Lj$/time/LocalDate;Lj$/time/i;)Lj$/time/LocalDateTime;
    ...
    .line 0
    invoke-static {v0}, Lj$/time/chrono/b;->s(Lj$/time/chrono/ChronoZonedDateTime;)Lj$/time/Instant;
    ...
    iget-object v7, p0, Lj$/time/format/v;->e:Lj$/time/format/G;
    ...
    :cond_6
    invoke-virtual {v7}, Lj$/time/format/G;->h()I
